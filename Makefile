...
ifeq ($(USEGNU),1)
	...
	PHIFLAGS= 
	ifeq ($(DEBUG),1)
		OTHERFLAGS = -ffixed-line-length-132 -g -pg -W -Wall -fPIC -cpp $(LEON) $(EXTRA) 
#		OMP=
#		OMPLIB=
	else
		OTHERFLAGS = -ffixed-line-length-132 -fopenmp -O3 -fPIC -cpp $(LEON) $(EXTRA) 
	endif
endif
...
compton.o: ./compton.f90
	$(FC) $(FFLAGS) $(OTHERFLAGS) -c	./compton.f90
...
./polsynchemis.f90 ./geodesics.f90 ./math.f90 ./camera.f90 ./phys_constants.f90 ./bessel.f90 ./grtrans.f90 ./grtrans_program.f90 ./compton.f90

OBJ = phys_constants.o odepack_aux.o interpolate_aux.o geokerr_wrapper.o interpolate.o read_inputs.o class_four_vector.o odepack.o compton.o emis.o rad_trans.o radtrans_integrate.o kerr.o fluid.o grtrans_driver.o calcgmin.o calc_maxjutt.o calc_maxcomp.o fluid_model_sphacc.o pgrtrans.o\
polsynchemis.o geodesics.o math.o camera.o bessel.o fits.o fluid_model_thindisk.o fluid_model_phatdisk.o fluid_model_numdisk.o fluid_model_hotspot.o fluid_model_hotspot_schnittman.o fluid_model_ffjet.o fluid_model_harm.o fluid_model_koral.o fluid_model_harmpi.o fluid_model_iharm.o fluid_model_koral3d.o fluid_model_harm3d.o fluid_model_thickdisk.o fluid_model_mb09.o fluid_model_sariaf.o fluid_model_toy.o fluid_model_powerlaw.o grtrans.o grtrans_program.o chandra_tab24.o 

OBJPUB = phys_constants.o odepack_aux.o interpolate_aux.o geokerr_wrapper.o interpolate.o read_inputs.o class_four_vector.o odepack.o compton.o emis.o rad_trans.o radtrans_integrate.o kerr.o fluid.o grtrans_driver.o calcgmin.o calc_maxjutt.o calc_maxcomp.o fluid_model_sphacc.o  \
